...
extract_date_start = '2024-06-23 00:00:00'
extract_date_end = '2024-06-23 23:59:59'
...
# step 6: df to csv.gz
final_result.to_csv(r"C:\Users\steveko\Downloads\daily_transaction_check23.csv", index=False)
